...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-editdata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13669&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-editdata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-editdata` can be installed with:

```
conda install r-editdata
```

It is possible to list all of the versions of `r-editdata` available on your platform with:
